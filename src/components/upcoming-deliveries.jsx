      ...
      <CardHeader className="border-b border-border py-4 px-6 bg-muted/30">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-sm font-bold text-foreground">Deadlines</CardTitle>
          </div>
          <span className="text-[10px] font-semibold text-indigo-500 bg-indigo-500/10 px-2 py-1 rounded-full">Next 5</span>
        </div>
      </CardHeader>
