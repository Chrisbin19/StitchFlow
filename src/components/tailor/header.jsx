...
import { Scissors, LogOut, Settings, Sun, Moon } from "lucide-react";
import Link from "next/link";
import TailorNotificationBell from "./TailorNotificationBell";

/* Shared CSS token system — identical to Admin/Cashier dashboards */
const TailorThemeVars = () => (
  <style>{`
        ...
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <TailorNotificationBell
              userId={userId}
              onSelectTask={(task) => console.log("Selected task for stitching:", task)}
            />
            ...
            <Link href={`/tailor/${userId}/profile`}>
              <button className="w-8 h-8 rounded-lg flex items-center justify-center transition-colors"
                ...
                onMouseEnter={e => e.currentTarget.style.background = 'var(--adm-divider)'}
