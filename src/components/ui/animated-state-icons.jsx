...
export function NotificationIcon({ size = 40, color = "currentColor", className, duration = 2800, hasNotification = false }) {
    const notif = hasNotification !== undefined ? hasNotification : useAutoToggle(duration);
    return (
...
export function HeartIcon({ size = 40, color = "currentColor", className, duration = 2000 }) {
...
export function SendIcon({ size = 40, color = "currentColor", className, duration = 2600, sent: sentProp }) {
    const autoSent = useAutoToggle(duration);
    const sent = sentProp !== undefined ? sentProp : autoSent;
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
            <motion.g
                animate={sent
